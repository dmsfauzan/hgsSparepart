...
use App\Filament\Resources\PartinHResource\Pages;
...
class PartinHResource extends Resource
{
    protected static ?string $model = PartinH::class;
    protected static ?string $navigationIcon = 'heroicon-o-arrow-down-tray';
    protected static ?string $navigationLabel = 'Sparepart In';
    protected static ?string $slug = 'Sparepart-In';
    protected static ?string $modelLabel = 'Sparepart In';
    protected static ?string $pluralModelLabel = 'Sparepart In';
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\Action::make('pdf')
                    ...
                    ->color('success')
                    ->url(fn ($record) => route('partin.pdf', $record->id))
                    ->openUrlInNewTab(),
    ...
    {
        return [
            'index' => Pages\ListPartinHS::route('/'),
            'create' => Pages\CreatePartinH::route('/create'),
            'edit' => Pages\EditPartinH::route('/{record}/edit'),
        ];
    }
}